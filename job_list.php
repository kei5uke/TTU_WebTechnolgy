    ...
    <div class="content">
        <div class="list">
            ...
            if (isset($_POST['search'])) {
                ...
                $search = "%$search%";
                $data = "SELECT * FROM job_form_data where title_text like ? or companyname_text like ?";
                $query = $connection->prepare($data);
                $query->bind_param("ss", $search, $search);
            } else {
                $data = "SELECT * FROM job_form_data;";
                $query = $connection->prepare($data);
            }
            ...
            foreach ($result as $row) {
                $url = "'job_description.php?id=" . $row['ID'] . "'";
                $content = "<li><a href=" . $url . ">";
                $content .= "<img src='img/client.jpeg' alt='client'>";
                $content .= sprintf("<p><b>%s</b><br>%s</p>", $row['companyname_text'], $row['title_text']);
                $content .= "</a></li>";
            ...
            <ul class="pagination" id="pagination">
                <?php if ($page > 1) : ?>
                    <li><a href="job_list.php?page=<?php echo ($page - 1); ?>"><?php echo $page - 1 ?></a></li>
                    <li><?php echo $page ?></li>
                    <li><a href="job_list.php?page=<?php echo ($page + 1); ?>"><?php echo $page + 1 ?></a></li>
                <?php endif; ?>
                <?php if ($page < $max_page) : ?>
                    <li><?php echo $page ?></li>
                    <li><a href="job_list.php?page=<?php echo ($page + 1); ?>"><?php echo $page + 1 ?></a></li>
                    <li><a href="job_list.php?page=<?php echo ($page + 2); ?>"><?php echo $page + 2 ?></a></li>
                <?php endif; ?>
            </ul>
